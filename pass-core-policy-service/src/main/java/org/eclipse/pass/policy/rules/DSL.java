...
public class DSL implements PolicyResolver {
    ...
    public List<PolicyRules> getPolicyRuleList() {
        return this.policyRulesList;
    }

    public void setPolicyRuleList(List<PolicyRules> policyRulesList) {
        this.policyRulesList = policyRulesList;
    }
}
