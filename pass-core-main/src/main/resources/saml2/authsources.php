...
$config = array(
    ...
    'example-userpass' => array(
        ...
        'user1:password' => array_merge($test_user_base, array(
            ...
            'urn:oid:1.3.6.1.4.1.5923.1.1.1.9' => array('MEMBER@johnshopkins.edu', 'FACULTY@johnshopkins.edu'),
        ...
        'user2:password' => array_merge($test_user_base, array(
            ...
            'urn:oid:1.3.6.1.4.1.5923.1.1.1.9' => array('FACULTY@johnshopkins.edu'),
